...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/admin/summernote-0.8.18-dist/summernote-bs4.min.css') }}">
</head>
...
<body class="hold-transition sidebar-mini">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('imageheader.index') }}" class="nav-link">
    ...
    <script src="{{ asset('assets/admin/summernote-0.8.18-dist/summernote-bs4.min.js') }}"></script>
    <script>
